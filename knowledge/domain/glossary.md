...
| **sheet** | A *tab* inside that document, modelled as [`Sheet`](/domain/sheet-and-user.md). Never the document itself. |
...
| **serial number** | The Sheets date encoding: days since 1899-12-30 plus a fractional day. See [spreadsheet layout](/domain/spreadsheet-layout.md). |
